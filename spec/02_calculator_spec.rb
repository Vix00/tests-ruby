...
describe "sum" do
  it "computes the sum of an empty array" do #calcule la somme d'un tableau vide
    expect(sum([])).to eq(0)
  end

  it "computes the sum of an array of one number" do #calcule la somme d'un tableau d'un nombre
...
describe "#power" do #puissance = ** (ex 2x2x2)
